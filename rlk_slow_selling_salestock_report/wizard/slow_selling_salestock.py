...
class SlowSellingSalestockReport(models.TransientModel):
    ...
    type_aging = fields.Selection([('A','3-8 Weeks'),('B','28 Weeks and Over')], string='Aging')
    ...
    def print_excel_report(self):
        ...
        worksheet.merge_range('F1:Q1', '', wbf['title_doc'])
        worksheet.merge_range('F2:Q2', '', wbf['title_doc'])
