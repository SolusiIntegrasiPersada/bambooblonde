...
class SummarySalesReport(models.TransientModel):
    ...
    def add_workbook_format(self, workbook):
        ...
        wbf['footer'] = workbook.add_format({'bold': 1,'align': 'center','font_color': '#000000', 'font_name': 'Georgia'})
        ...
        wbf['content_float_bold'] = workbook.add_format({'align': 'left','num_format': '#,##0', 'font_name': 'Georgia', 'bg_color': '#FFFFFF','bold':True})
        wbf['content_float'] = workbook.add_format({'align': 'left','num_format': '#,##0', 'font_name': 'Georgia', 'bg_color': '#FFFFFF',})
        # wbf['content_float'].set_right() 
        # wbf['content_float'].set_left()

        wbf['content_number'] = workbook.add_format({'align': 'left', 'num_format': '#,##0', 'font_name': 'Georgia', 'bg_color': '#FFFFFF',})
