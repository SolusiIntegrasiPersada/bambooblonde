...
class StockOnHandPerStoreXlsx(models.AbstractModel):
  ...
  def generate_xlsx_report(self, workbook, data, obj):
    ...
    for i in quant_ids['name_warehouse_id']:
      ...
      worksheet.merge_range('F3:F4', 'Stock Name', format_header)
      worksheet.merge_range('G3:G4', 'Stock Cat', format_header)
      ...
      worksheet.merge_range('K3:K4', 'Display', format_header)
      ...
      for i in quant_ids:
        ...
        worksheet.write(row, 5, i['product'], style_basic_center)
        worksheet.write(row, 6, f'{subcategory}', style_basic_center)
