...
registry
    ...
    .add("pdf_report_options_handler", async function (action, options, env) {
        ...
        console.log(default_print_option)
        ...
        if (action.name === 'SDT - Slip Tagihan' || action.name === 'SDT - Surat Jalan' || action.name === 'SDT - Surat Jalan Customer') {
            default_print_option = 'print';
        }
        console.log(default_print_option)
