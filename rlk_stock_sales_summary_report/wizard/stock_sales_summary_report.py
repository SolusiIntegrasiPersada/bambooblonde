...
class StockSalesSummaryReport(models.TransientModel):
    ...
    def print_excel_report(self):
        ...
        if self.env.user.company_id.logo:
            ...
            worksheet.insert_image('O3:Q6', "image.png", {'image_data': logo_company, 'bg_color': '#FFFFFF', 'x_scale': resize_scale, 'y_scale': resize_scale})
        ...
        for rec in sorted_data:
            ...
            for rec1 in rec['categories']:
                worksheet.merge_range('%s%s:%s%s' %(col0, row, col16, row), '     ' + rec1['category'] or '', wbf['title_doc3'])
                row+=1
                subtotal_size1 = 0
                subtotal_size2 = 0
                subtotal_size3 = 0
                ...
                for rec2 in rec1['lines']:
                    ...
                    worksheet.write('%s%s:%s%s' %(col12, row, col13, row), rec2['sale_price'] or '', wbf['content_float'])
                    worksheet.write('%s%s:%s%s' %(col13, row, col14, row), rec2['subtotal'] or '', wbf['content_float'])
                    worksheet.write('%s%s:%s%s' %(col14, row, col15, row), rec2['cost_price'] or '', wbf['content_float'])
                    worksheet.write('%s%s:%s%s' %(col15, row, col16, row), rec2['cost_subtotal'] or '', wbf['content_float'])
                ...
                worksheet.merge_range('%s%s:%s%s' %(col0, row, col2, row), 'Sub Total ' + str(rec1['category']), wbf['title_doc3_float'])
                worksheet.write('%s%s:%s%s' %(col2, row, col13, row), '', wbf['title_content_number'])
                worksheet.write('%s%s:%s%s' %(col3, row, col14, row), subtotal_size1 or '', wbf['title_content_number'])
                worksheet.write('%s%s:%s%s' %(col4, row, col15, row), subtotal_size2 or '', wbf['title_content_number'])
                ...
                worksheet.write('%s%s:%s%s' %(col9, row, col10, row), subtotal_size7 or '', wbf['title_content_number'])
                worksheet.write('%s%s:%s%s' %(col10, row, col11, row), subtotal_size8 or '', wbf['title_content_number'])
            ...
            worksheet.merge_range('%s%s:%s%s' %(col0, row, col2, row), 'Total ' + str(rec['parent_category']), wbf['title_doc3_float'])
            worksheet.write('%s%s:%s%s' %(col2, row, col13, row), '', wbf['title_content_number'])
    ...
    def add_workbook_format(self, workbook):
        ...
        wbf['footer'] = workbook.add_format({'bold': 1,'align': 'center','font_color': '#000000', 'font_name': 'Georgia', 'bg_color': colors['white']})
        ...
        wbf['header_no'] = workbook.add_format({'bold': 1,'align': 'left','bg_color': colors['orange'],'font_color': '#000000', 'font_name': 'Georgia'})
        wbf['header_number'] = workbook.add_format({'bold': 1,'align': 'center','bg_color': colors['orange'],'font_color': '#000000', 'font_name': 'Georgia'})
        ...
        wbf['content'] = workbook.add_format({'align': 'left', 'font_name': 'Georgia', 'bg_color': '#FFFFFF',})
        wbf['content'].set_font_size(11)
        # wbf['content'].set_left()
        # wbf['content'].set_right() 

        wbf['content2'] = workbook.add_format({'align': 'left', 'font_name': 'Georgia', 'bg_color': '#FFFFFF',})
        wbf['content2'].set_font_size(11)
        # wbf['content2'].set_left()
        # wbf['content2'].set_right() 
        
        wbf['content_float'] = workbook.add_format({'align': 'right','num_format': '#,##0', 'font_name': 'Georgia', 'bg_color': '#FFFFFF',})
        # wbf['content_float'].set_right() 
        # wbf['content_float'].set_left()

        wbf['title_content_number'] = workbook.add_format({'bold':1,'align': 'center', 'num_format': '#,##0', 'font_name': 'Georgia', 'bg_color': '#FFFFFF',})
        wbf['content_number'] = workbook.add_format({'align': 'center', 'num_format': '#,##0', 'font_name': 'Georgia', 'bg_color': '#FFFFFF',})
        ...
        wbf['total_float'] = workbook.add_format({'bold':1, 'align':'right', 'num_format':'#,##0', 'font_name': 'Georgia', 'bg_color': '#FFFFFF',})
