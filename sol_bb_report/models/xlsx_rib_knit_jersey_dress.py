...
class XlsxRibKnitJerseyDress(models.Model):
    _name = 'report.sol_bb_report.rib_knit_jersey_dress.xlsx'
    ...
    def generate_xlsx_report(self, workbook, data, objs):
        ...
        row = 1
        sheet.merge_range(row, 0, row, len(header_table_real)-1, f'RIB KNIT & JERSEY DRESS {product_model_id.name}', formatNormal)
        row += 1
